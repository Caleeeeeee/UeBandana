...
class RespondToStudentsPage : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_respond_to_students_page)
        ...
        navigationView.setCheckedItem(R.id.nav_respond)
