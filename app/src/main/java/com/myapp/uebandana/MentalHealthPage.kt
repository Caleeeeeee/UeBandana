...
class MentalHealthPage : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (navigationView.menu.findItem(R.id.nav_mental_health) != null) {
            navigationView.setCheckedItem(R.id.nav_mental_health)
        }
